...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-red-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="text-white text-3xl pt-8">Welcome Back ROY</h1>
        <h2 class="text-red-300">Enter your credentials below</h2>
        <form method="POST" action="{{ route('login') }}" class="pt-8">
                        ...
                        <div class="relative">
                            ...
                            <div class="">
                                <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-red-800 text-gray-100 outline-none focus:bg-red-700" placeholder="your@email.com" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus>

                                @error('email')
                                    <span class="text-white pt-1 text-sm" role="alert">
                        ...
                        <div class="relative pt-3">
                            ...
                            <div class="">
                                <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-red-800 text-gray-100 outline-none focus:bg-red-700" placeholder="Password" name="password" value="{{ old('email') }}"  autofocus>
